...
class GetPhoneNumberCursorPositionUseCaseTest {
    ...
    @Test
    fun `should return cursor position when inputting first digit`() = runTest {
        val input = "+71"
    ...
    @Test
    fun `should return cursor position when deleting first digit`() = runTest {
        val input = "+7 ("
        val formatPhoneNumber = "+7"
        every { formatPhoneNumber(input) } returns formatPhoneNumber
    ...
    @Test
    fun `should return cursor position when inputting 4th digit`() = runTest {
        val input = "+7 (1234"
    ...
    @Test
    fun `should return cursor position when deleting 4th digit`() = runTest {
        val input = "+7 (123) "
    ...
    @Test
    fun `should return cursor position when deleting non-digit`() = runTest {
        val input = "+7 123"
    ...
    @Test
    fun `should return cursor position when inputting 11th digit`() = runTest {
    ...
    @Test
    fun `should return cursor position when inputting 11th digit in the middle`() = runTest {
