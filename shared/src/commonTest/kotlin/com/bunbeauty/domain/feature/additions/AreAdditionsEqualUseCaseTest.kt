...
class AreAdditionsEqualUseCaseTest {
    ...
    @Test
    fun `return true when additions are equal`() =
        runTest {
            val result =
    ...
    @Test
    fun `return true when additions are equal and have different order`() =
        runTest {
            val result =
                areAdditionsEqualUseCase(
                    cartProduct =
    ...
    @Test
    fun `return false when cart product has more additions`() =
        runTest {
            val result =
                areAdditionsEqualUseCase(
                    cartProduct =
    ...
    @Test
    fun `return false when cart product has less additions`() =
        runTest {
            val result =
                areAdditionsEqualUseCase(
                    cartProduct =
    ...
    @Test
    fun `return false when cart product has different additions`() =
        runTest {
            val result =
                areAdditionsEqualUseCase(
                    cartProduct =
