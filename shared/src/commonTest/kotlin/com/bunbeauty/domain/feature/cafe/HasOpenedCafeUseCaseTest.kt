...
class HasOpenedCafeUseCaseTest {
    ...
    @Test
    fun `invoke should return true when at least one cafe has pickup enabled`() =
        runTest {
            // Arrange
            val cafes =
                listOf(
    ...
    @Test
    fun `invoke should return false when no cafes have pickup enabled`() =
        runTest {
            // Arrange
            val cafes =
                listOf(
    ...
    @Test
    fun `invoke should return false when cafe list is empty`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke should check all cafes until finding first with pickup enabled`() =
        runTest {
            // Arrange
            val cafes =
                listOf(
