...
class VersionRepository(private val networkConnector: NetworkConnector) : BaseRepository(),
    VersionRepo {

    override val tag: String = "VERSION_TAG"

    override suspend fun getForceUpdateVersion(): Int {
        return networkConnector.getForceUpdateVersion()
            .getNullableResult { forceUpdateVersionServer ->
