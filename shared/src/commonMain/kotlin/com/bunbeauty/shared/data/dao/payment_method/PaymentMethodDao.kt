...
class PaymentMethodDao(foodDeliveryDatabase: FoodDeliveryDatabase) : IPaymentMethodDao {
    ...
    override suspend fun getPaymentMethodList(): List<PaymentMethodEntity> {
        return paymentMethodEntityQueries.getPaymentMethodList().executeAsList()
    }
}