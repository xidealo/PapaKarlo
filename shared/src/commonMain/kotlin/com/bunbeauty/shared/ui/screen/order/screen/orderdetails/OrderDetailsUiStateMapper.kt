...
@Composable
fun OrderDetails.DataState.mapToOrderDetailsViewState() = OrderDetailsViewState(
    orderProductItemList = orderDetailsData.orderProductItemList.map {
        it.toItem()
    },
    ...
    orderInfo =
        orderDetailsData.orderInfo?.let { orderInfo ->
            OrderDetailsViewState.OrderInfo(
                ...
                deferredTime = orderInfo.deferredTime?.getTimeString()
