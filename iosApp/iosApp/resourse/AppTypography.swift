...
extension Text {
    func titleSmall(weight: Font.Weight = .regular) -> Text {
        return font(Font.system(size: 14, weight: weight, design: .default))
    }

    func titleMedium(weight: Font.Weight = .regular) -> Text {
        return font(Font.system(size: 16, weight: weight, design: .default))
    }

    func labelSmall(weight: Font.Weight = .regular) -> Text {
        return font(Font.system(size: 11, weight: weight, design: .default))
    }

    func labelMedium(weight: Font.Weight = .regular) -> Text {
        return font(Font.system(size: 12, weight: weight, design: .default))
    }
